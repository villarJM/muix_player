...
class ArtistsDetailScreen extends StatefulWidget {
  ...
  const ArtistsDetailScreen({ Key? key, required this.songList, required this.albumList}) : super(key: key);
                                ...
                                builder: (context, albumList,_) {
                                  return InkWell(
                                    onTap: () {
                                      ...
                                      final albums = songList.where((item) => item.album == widget.albumList[index].album).toList();
                                            ...
                                            Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(widget.albumList[index].album, maxLines: 1, overflow: TextOverflow.fade, ),
                                                    Row(
                                                      children: [
                                                        Expanded(child: Text(widget.albumList[index].artist ?? "", maxLines: 1, overflow: TextOverflow.clip, ),),
                                                        const Text(' | 2023', maxLines: 1, overflow: TextOverflow.fade, textAlign: TextAlign.end, ),
                                                      ],
                                                    ),
                                                    Text('${widget.albumList[index].numOfSongs} Songs', )
                                                  ],
                                                ),
                                              ),
                                            )
