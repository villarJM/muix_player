...
class WavePainter extends CustomPainter {
  ...
  _paintStartupWave(Canvas canvas, Size size) {
    ...
    double waveHeight = lerpDouble(
        size.height,
        line.controlHeight,
        Curves.elasticOut.transform(animationProgress)) as double;
  ...
  _paintStoppingWave(Canvas canvas, Size size) {
    ...
    double waveHeight = lerpDouble(line.controlHeight,
        size.height, Curves.elasticOut.transform(animationProgress)) as double;
  ...
  WaveCurveDefinitions _calculateWaveLineDefinitions(Size size) {
    ...
    double bend =
        lerpDouble(0.0, bendability, slideDifference / maxSlideDifference) as double;
